...
const buttonSystem = cva(
	'w-auto select-none flex items-center justify-center rounded-lg font-semibold transition-all duration-300 ease-in-out outline-none focus:outline-none active:outline-none',
	{
		variants: {
			variant: {
				primary: 'bg-indigo-500 hover:bg-indigo-700 focus: text-white',
				secondary: 'bg-gray-500 text-white',
				text: 'bg-transparent text-indigo-500',
				link: 'bg-transparent text-indigo-500 underline',
			},
			size: {
...
export type ButtonProps = ComponentProps<'button'> & VariantProps<typeof buttonSystem>;
